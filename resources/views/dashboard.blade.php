<x-app-layout>
    ...
    <div class="py-5">
        <div
            ...
            <a href="{{url('payments')}}" class="bg-white flex-1  shadow-sm sm:rounded-lg p-5">
                <p class="font-bold">Total de Links</p>
                <p>{{ $data['numbers']['payments'] }}</p>
            </a>
            <a href="{{url('payments?status=active')}}" class="bg-white flex-1  shadow-sm sm:rounded-lg p-5">
                <p class="font-bold">Ativos</p>
                <p>{{ $data['numbers']['active'] }}</p>
            </a>
            <a href="{{url('payments?status=expired')}}" class="bg-white flex-1  shadow-sm sm:rounded-lg p-5">
                <p class="font-bold">Expirados</p>
                <p>{{ $data['numbers']['expired'] }}</p>
            </a>
            <a href="{{url('payments?status=inactive')}}" class="bg-white flex-1  shadow-sm sm:rounded-lg p-5">
                <p class="font-bold">Inativos</p>
                <p>{{ $data['numbers']['inactive'] }}</p>
            </a>
            <a href="{{url('payments?status=paid')}}" class="bg-white flex-1  shadow-sm sm:rounded-lg p-5">
                <p class="font-bold">Pagos</p>
                <p>{{ $data['numbers']['paid'] }}</p>
            </a>
            <a href="{{url('payments?status=cancelled')}}" class="bg-white flex-1  shadow-sm sm:rounded-lg p-5">
